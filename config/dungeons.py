...
DUNGEONS = {
    ...
    "void_realm": Dungeon(
        ...
        max_floors=10,
        floor_enemies={
            1: [ENEMY_TEMPLATES["ancient_dragon_enemy"]],
            2: [ENEMY_TEMPLATES["ancient_dragon_enemy"], ENEMY_TEMPLATES["lich_rat_enemy"]],
            3: [ENEMY_TEMPLATES["lich_rat_enemy"]],
            4: [ENEMY_TEMPLATES["lich_rat_enemy"], ENEMY_TEMPLATES["ancient_dragon_enemy"]],
            5: [ENEMY_TEMPLATES["lich_rat_enemy"], ENEMY_TEMPLATES["lich_rat_enemy"]],
            6: [ENEMY_TEMPLATES["phoenix_rat_enemy"]],
            7: [ENEMY_TEMPLATES["phoenix_rat_enemy"], ENEMY_TEMPLATES["lich_rat_enemy"]],
            8: [ENEMY_TEMPLATES["phoenix_rat_enemy"], ENEMY_TEMPLATES["phoenix_rat_enemy"]],
            9: [ENEMY_TEMPLATES["phoenix_rat_enemy"], ENEMY_TEMPLATES["lich_rat_enemy"]],
            10: [ENEMY_TEMPLATES["phoenix_rat_enemy"], ENEMY_TEMPLATES["ancient_dragon_enemy"]]
        },
        boss_enemy=ENEMY_TEMPLATES["ancient_dragon_enemy"],
